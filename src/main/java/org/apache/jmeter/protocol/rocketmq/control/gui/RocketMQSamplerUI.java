package org.apache.jmeter.protocol.rocketmq.control.gui;
...
import org.apache.jmeter.protocol.rocketmq.sampler.RocketMQSampler;
...
public class RocketMQSamplerUI extends AbstractSamplerGui {
...
//	private final JLabeledTextField keySerializerField = new JLabeledTextField(JMeterUtils.getResString("kafka.key.serializer", "Key Serializer"));
	...
	private final JLabeledTextField brokersField = new JLabeledTextField("ServerIP");
	private final JLabeledTextField topicField = new JLabeledTextField("Topic");
	private final JLabeledTextField tagField = new JLabeledTextField("Tags");
...
//		DPanel.add(keySerializerField);
	...
	public TestElement createTestElement() {
		RocketMQSampler sampler = new RocketMQSampler();
	...
	public void clearGui() {
		super.clearGui();
		this.brokersField.setText("rocketmq_server:9876");
...
//		this.keySerializerField.setText("kafka.serializer.StringEncoder");
	...
	public void configure(TestElement element) {
		...
		RocketMQSampler sampler = (RocketMQSampler)element;
		this.brokersField.setText(sampler.getNameSrv());
		this.topicField.setText(sampler.getTopic());
		this.tagField.setText(sampler.getTag());
...
//		this.keySerializerField.setText(sampler.getKeySerializer());
	...
	private void setupSamplerProperties(RocketMQSampler sampler) {
		this.configureTestElement(sampler);
		sampler.setNameSrv(this.brokersField.getText());
		sampler.setTopic(this.topicField.getText());
		sampler.setTag(this.tagField.getText());
...
//		sampler.setKeySerializer(this.keySerializerField.getText());
	...
	public void modifyTestElement(TestElement testElement) {
		RocketMQSampler sampler = (RocketMQSampler) testElement;
		this.setupSamplerProperties(sampler);
	}
}
